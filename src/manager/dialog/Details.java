...
public class Details extends Dialog {
	...
	private void createContents() {
		...
		btnNewButton_1.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseDown(MouseEvent e) {
				Alter alter = new Alter(new Shell(), SWT.CLOSE);
				alter.setCurrentUser(currentUser);
				shell.close();
				alter.open();
			}
		});
		...
		Label lblNewLabel_17 = new Label(shell, SWT.BORDER);
		lblNewLabel_17.setBounds(456, 47, 118, 143);
		if(!currentUser.getPhoto().equals(""))
			lblNewLabel_17.setImage(SWTResourceManager.getImage("F:\\workspace\\hpmanagement"+File.separator+currentUser.getPhoto()));
